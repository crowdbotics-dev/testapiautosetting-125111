...
## Project Structure
    ...
    ├── testapiautosetting_125111  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125111`
...
2. Clone this repo and `cd testapiautosetting_125111`
